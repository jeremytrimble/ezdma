...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.FIFO_DEPTH {4096} CONFIG.FIFO_MODE {2}  ] $axis_data_fifo_0
  ...
  set_property -dict [ list CONFIG.IN0_WIDTH {1} CONFIG.NUM_PORTS {16}  ] $xlconcat_0
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_SG [get_bd_intf_pins axi_dma_1/M_AXI_SG] [get_bd_intf_pins axi_mem_intercon/S01_AXI]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_dma_1/S_AXI_LITE] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]
